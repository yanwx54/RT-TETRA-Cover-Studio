...
> 当前状态：V1.0 文档体系初稿完成，技术栈已确定，核心计算、标准算例、结果序列化和边界测试已完成。
...
当前项目已有可测试的核心计算模块、四类传播模型初版、标准算例、结果序列化接口和边界测试，但还没有 GUI 或可运行应用。下一步应开始 GUI 原型。
...
1. 准备 GUI 原型：参数输入、场景切换、计算按钮、结果展示。
2. 接入曲线展示。
3. 再开发报告导出。
